  ...
  return (
    <section className="max-w-2xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-12">
        <div>
          <h1 className="text-4xl font-bold text-[#c16340] mb-2">
            Giuseppe Tardi
          </h1>
          <h2 className='text-2xl font-medium text-[#92abac] italic'>
      ...
      <div className="space-y-8">
        <div className="bg-[#ea8d50]/10 rounded-lg p-6 border-l-4 border-[#ea8d50]">
          <p className="text-xl font-medium text-[#ea8d50]">
        ...
        <div className="space-y-6 text-[#333]">
          <p className="text-lg leading-relaxed text-[#92abac]">
          ...
          <p className="text-lg leading-relaxed text-[#92abac] font-medium">
